<div class="p-6">
    <h2 class="text-2xl font-bold mb-4">Editar Título</h2>
    ...
    <form wire:submit="save" class="max-w-2xl">
        ...
        <div class="mt-6 flex gap-3">
            ...
            <a href="{{ route('titulos.show', $titulo->id) }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded hover:bg-gray-400">
                Cancelar
            </a>
        </div>
    </form>
